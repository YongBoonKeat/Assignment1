...
public class Mamee extends PackagedFood{
	String brand,flavour;
	int quantity;
	double price;
	double discount;

	public Mamee(String type,String item,String brand, String flavour,int quantity,double price) {//Constructor with argument
		super(type,item);
		this.brand = brand;
