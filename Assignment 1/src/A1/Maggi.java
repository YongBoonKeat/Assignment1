...
public class Maggi extends PackagedFood{
		String brand,flavour;
		int quantity;
		double price;
		double discount;

		public Maggi(String type,String item,String brand, String flavour,int quantity,double price) {//Constructor with argument
			super(type,item);
			this.brand = brand;
