...
public class Finance {//1.3 User Define Class
	...
	public Finance(double income,double salary,double inventoryTotalPricePurchase) {//1.4 Constructor with three argument
		System.out.print("Enter Incidental Charges: ");
		this.incidentalCharges = input.nextDouble();
	...
	void ReportFinance() {//Method to print Report Finance
		totalProfit = (this.income -(this.salary + this.inventoryTotalPricePurchase +this.incidentalCharges));
		System.out.println("=========================================================================================================================================");
